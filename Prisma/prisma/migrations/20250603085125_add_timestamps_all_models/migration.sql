/*
  ...
  - You are about to drop the column `addedAt` on the `Favorite` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Favorite" DROP COLUMN "addedAt",
...
-- AlterTable
ALTER TABLE "Stat" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "deletedAt" TIMESTAMP(3),
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
